...
<ul>
	...
	<li style="color: {textColor}">
		...
		{#if zKey == "prev"}
		<span class="" style="color: #801650; font-weight: bold">(2011 </span><span class="{changeClass(Math.round(item[yKey] - item[zKey]))}" >{changeStr(Math.round(item[yKey] - item[zKey]), 'pp')}</span><span class="" style="color: #801650; font-weight: bold"></span>)</span>
		{:else if zKey}
